...
export default function OverlayControlPage() {
  ...
  useEffect(() => {
    const feed = {
      striker, strikerRuns: sr, strikerBalls: sb,
      nonStriker: non, nonStrikerRuns: nr, nonStrikerBalls: nb,
      bowler, bowlerOvers: bo, bowlerRuns: br, bowlerWickets: bw,
      thisOver: balls, projected: proj, target, need, rrr,
    };
    try {
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-6 rounded-[2rem] bg-slate-950 p-7 text-white shadow-xl">
          ...
          <p className="mt-2 max-w-3xl text-sm font-semibold text-white/60">
            STUMPS gives team score automatically. If STUMPS does not expose batsman/bowler feed, this panel pushes manual live details to the overlay and also builds an OBS URL.
          </p>
        </div>
