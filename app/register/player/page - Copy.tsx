  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (isEditMode) {
        ...
        setGeneratedPlayerCode(data?.player_code || "");
        ...
        <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-slate-900 to-emerald-900 p-6 text-white shadow-xl sm:p-8">
          ...
          <p className="mt-4 max-w-2xl text-sm leading-7 text-slate-200 sm:text-base">
            {isEditMode
              ...
              : "This protected registration is linked to your logged-in account and stored for admin review."}
          </p>
        </div>
      </section>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <div className="rounded-3xl bg-white p-5 shadow-md ring-1 ring-slate-200">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Your submission is tied to your own account for secure tracking and review.
            </p>
          </div>
          ...
          <div className="rounded-3xl bg-white p-5 shadow-md ring-1 ring-slate-200">
            ...
            <p className="mt-2 text-sm text-slate-600">
              Editing an existing record sends it back into review with pending status.
            </p>
          </div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-6 sm:px-6 lg:px-8">
        <div className="rounded-3xl bg-white p-5 shadow-md ring-1 ring-slate-200 sm:p-6">
          ...
          <form className="grid gap-5 md:grid-cols-2" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="mb-2 block text-sm font-semibold text-slate-800">City / Base</label>
              <input
                type="text"
                value={form.cityBase}
            ...
            <div>
              <label className="mb-2 block text-sm font-semibold text-slate-800">Current Team</label>
              <input
                type="text"
            ...
            <div>
              <label className="mb-2 block text-sm font-semibold text-slate-800">Batting Style</label>
              <select
            ...
            <div>
              <label className="mb-2 block text-sm font-semibold text-slate-800">Bowling Style</label>
              <input
                type="text"
            ...
            <div>
              ...
              <p className="mt-2 text-xs text-slate-500">
                {!isEditMode
                  ? "Profile photo is required for new registration. On mobile, camera capture can open directly."
                  : existingPhotoUrl
            ...
            <div>
              <label className="mb-2 block text-sm font-semibold text-slate-800">Preferred Tournament</label>
              <select
