                            ...
                            <>
                              <p className="text-sm font-semibold text-slate-900">
                                {latestResult.title ||
                                  `${
                                    getTeamNameById(
                                      latestResult.team_a_id,
                                      tournamentTeams
                                    ) || "Team A"
                                  } vs ${
                                    getTeamNameById(
                                      latestResult.team_b_id,
                                      tournamentTeams
                                    ) || "Team B"
                                  }`}
                              </p>
                              ...
                              <p className="mt-1 text-sm text-slate-600">
                                Player of the Match:{" "}
                                {latestResult.player_of_match || "Not updated"}
                              </p>
                            </>
                          ) : (
                            <p className="text-sm text-slate-500">
                    ...
                    {loadingTournamentTeams ? (
                      <div className="grid gap-3 sm:grid-cols-2">
                        {[1, 2, 3, 4].map((item) => (
                          <div
                            key={item}
                            className="rounded-2xl border border-slate-200 bg-white px-4 py-4 shadow-sm transition hover:shadow-md"
                          >
                      ...
                      <EmptyCard text="Participating teams will appear here once tournament teams are linked." />
                    )}
                  </div>
                </div>
              </div>
